const {
  getShippingByCustomerId,
  getShippingByCustomerAndStatus,
  getShippingByStatus,
} = require("../repositories/shippingRepository");
...
const ShippingController = {
  ...
  async getShippingByCustomerId(req, res) {
    try {
      const shipping = await ShippingService.getShippingByCustomerId(
